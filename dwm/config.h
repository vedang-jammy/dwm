...
static const char col_cyan[]        = "#fca103"; /* border color focused windows and tags */
...
static const Rule rules[] = {
	...
	{ "Gimp",                 NULL,       NULL,       0,            1,         0,               -1 },
        ...
        { "Terminator",          NULL,       "cava",     ~0,            1,         1,               -1 },
        { "Terminator",          NULL,       "tty-clock",     ~0,            1,         1,               -1 },
        { "Terminator",          NULL,       "gtop",     ~0,            1,         1,               -1 },
};
